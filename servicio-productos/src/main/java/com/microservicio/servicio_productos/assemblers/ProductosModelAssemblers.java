    ...
    public EntityModel<ProductosDTO> toModel(ProductosDTO productosdto) {
        return EntityModel.of(productosdto,
                linkTo(methodOn(ProductosControllerV2.class)
                        .getProductosByCodigo(Integer.valueOf(productosdto.getIdProducto()))).withSelfRel(),
                linkTo(methodOn(ProductosControllerV2.class).getAllProductos()).withRel("productos"),
                linkTo(methodOn(ProductosControllerV2.class).guardarProductoDTO(productosdto)).withRel("guardar"),
                linkTo(methodOn(ProductosControllerV2.class).updateProductos(productosdto.getIdProducto(),
                        productosdto)).withRel("actualizar"),
                linkTo(methodOn(ProductosControllerV2.class).deleteProductos(productosdto.getIdProducto()))
                        .withRel("eliminar"),
                linkTo(methodOn(ProductosControllerV2.class).patchProdcutos(productosdto.getIdProducto(), productosdto))
